    ...
    <main className="container py-12">
      <div className="card">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <input className="input" type="password" placeholder="Password (min 8 chars)" value={password} onChange={e=>setPassword(e.target.value)} required />
          <button className="btn-primary">{loading ? 'Creating...' : 'Create account'}</button>
        </form>
